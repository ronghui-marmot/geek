...
@MapperScan(basePackages = "data1.mapper",sqlSessionFactoryRef = "data1SqlSessionFactory")
public class DataSource1 {
    ...
    @Primary
    public PlatformTransactionManager  transactionManager(@Qualifier("data1Source") DataSource ds){
        return new PlatformTransactionManager(ds);
    }
}
